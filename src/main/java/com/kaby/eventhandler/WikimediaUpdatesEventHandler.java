...
/**
 * This EventHandler will be triggered whenever there is a new update event triggered on Wikimedia
 */
public class WikimediaUpdatesEventHandler implements BackgroundEventHandler {

    private static final Logger LOGGER = LoggerFactory.getLogger(WikimediaUpdatesEventHandler.class);

    private KafkaTemplate<String, String> kafkaTemplate;
    private String topic;

    public WikimediaUpdatesEventHandler(KafkaTemplate<String, String> kafkaTemplate, String topic) {
    ...
    public void onMessage(String event, MessageEvent messageEvent) throws Exception {
        ...
        LOGGER.info(String.format("PRODUCER Event Data -> %s", messageEvent.getData()));

        // Send message event to Kafka Topic
